...
import { Package, Users, TrendingUp, Plus, Eye, Trash2, Edit, BarChart3, ShoppingBag, Sparkles } from "lucide-react";
    ...
    <div className="container py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Manage products, users, and submissions</p>
        </div>
        <Link to="/add-product">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Submissions */}
        <div className="rounded-xl border bg-card p-5">
          <h2 className="font-display text-lg font-semibold mb-4">Dupe Submissions</h2>
          <div className="space-y-3">
